//
//  IAuthorizationErrorResponse.cs
//
//  Author:
...
/// <summary>
/// Represents a failure to perform some remote operation when requesting
/// authorization.
/// </summary>
[PublicAPI]
public interface IAuthorizationErrorResponse
{
    /// <summary>
    /// Gets the error code.
    /// </summary>
    ...
    /// <summary>
    /// Gets the state the error is associated with.
    /// </summary>
