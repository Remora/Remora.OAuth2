//
//  AccessTokenRequestTestsBase.cs
//
//  Author:
...
/// <summary>
/// Serves as a test base for test classes that handle access token requests.
/// </summary>
/// <typeparam name="TAccessTokenRequest">The request type.</typeparam>
public abstract class AccessTokenRequestTestsBase<TAccessTokenRequest> where TAccessTokenRequest : IAccessTokenRequest
{
    /// <summary>
    ...
    /// </summary>
    protected abstract Func<TAccessTokenRequest> BlankRequestFactory { get; }

    /// <summary>
    /// Gets a function that creates a blank request with extension data in it.
    /// </summary>
    protected abstract Func<IAccessTokenRequestExtension, TAccessTokenRequest> ExtendedRequestFactory { get; }
