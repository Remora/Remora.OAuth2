//
//  TokenRevocationRequestTestsBase.cs
//
//  Author:
...
/// <summary>
/// Serves as a test base for test classes that handle tokenRevocation requests.
/// </summary>
/// <typeparam name="TTokenRevocationRequest">The request type.</typeparam>
public abstract class TokenRevocationRequestTestsBase<TTokenRevocationRequest> where TTokenRevocationRequest : ITokenRevocationRequest
{
    /// <summary>
    /// Gets a function that creates a blank request with no special data in it.
    /// </summary>
    protected abstract Func<TTokenRevocationRequest> BlankRequestFactory { get; }

    /// <summary>
    /// Gets a function that creates a blank request with extension data in it.
    /// </summary>
    protected abstract Func<ITokenRevocationRequestExtension, TTokenRevocationRequest> ExtendedRequestFactory { get; }
